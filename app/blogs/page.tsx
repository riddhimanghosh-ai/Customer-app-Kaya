          ...
          {blogs.map((blog) => (
            <div key={blog.id} className="panel" style={{ display: 'flex', flexDirection: 'column', overflow: 'hidden', cursor: 'pointer', transition: 'transform 0.15s ease' }}>
              ...
              <div style={{ padding: '20px', display: 'flex', flexDirection: 'column', flex: 1 }}>
                ...
                <button style={{ marginTop: '12px', color: 'var(--brand)', fontWeight: 600, fontSize: '13px', background: 'none', border: 'none', cursor: 'pointer', textDecoration: 'none' }} className="hover:underline">
                  Read More →
                </button>
              </div>
            </div>
