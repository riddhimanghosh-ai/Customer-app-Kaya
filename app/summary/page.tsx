...
const IconHome = (p: any) => <Icon {...p}><path d="M3.5 11 L12 4 L20.5 11 V20 H3.5 Z" /><path d="M10 20 V14 H14 V20" /><GoldNode cx={12} cy={8} /></Icon>;
const IconAppt = (p: any) => <Icon {...p}><rect x="3.5" y="5" width="17" height="15" rx="1.5" /><path d="M3.5 9.5 H20.5" /><path d="M8 3.5 V6.5 M16 3.5 V6.5" /><GoldNode cx={16} cy={14.5} /></Icon>;
const IconMed = (p: any) => <Icon {...p}><rect x="3" y="9" width="18" height="6" rx="3" transform="rotate(-30 12 12)" /><path d="M8.5 7.5 L15.5 16.5" /><GoldNode cx={15} cy={9.5} /></Icon>;
const IconProgress = (p: any) => <Icon {...p}><rect x="3.5" y="5.5" width="7.5" height="13" rx="1" /><rect x="13" y="5.5" width="7.5" height="13" rx="1" /><path d="M11 9 H13 M11 12 H13 M11 15 H13" strokeWidth="1" /><GoldNode cx={17} cy={9} /></Icon>;
const IconChat = (p: any) => <Icon {...p}><path d="M4 5.5 H20 V16 H13 L9 19.5 V16 H4 Z" /><circle cx="9" cy="11" r="0.6" fill="currentColor" stroke="none" /><circle cx="12" cy="11" r="0.6" fill="currentColor" stroke="none" /><GoldNode cx={15} cy={11} /></Icon>;
const IconSummary = (p: any) => <Icon {...p}><path d="M5 4 H15 L19 8 V20 H5 Z" /><path d="M8 10 H16 M8 13 H16 M8 16 H12" /><GoldNode cx={15} cy={8} /></Icon>;
const IconRewards = (p: any) => <Icon {...p}><circle cx="12" cy="10" r="6" /><path d="M8.5 14.5 L7 21 L12 18.5 L17 21 L15.5 14.5" /><GoldNode cx={12} cy={10} r={2} /></Icon>;
const IconRefer = (p: any) => <Icon {...p}><circle cx="8" cy="9" r="3" /><path d="M2.5 19 C2.5 15.5 5 13.5 8 13.5 C11 13.5 13.5 15.5 13.5 19" /><circle cx="17" cy="11" r="2.4" /><path d="M14 19 C14 16.5 15.5 15 17 15 C18.5 15 20.5 16.5 20.5 19" /><GoldNode cx={17} cy={11} /></Icon>;
const IconPackage = (p: any) => <Icon {...p}><path d="M3.5 7 L12 4 L20.5 7 V17 L12 20 L3.5 17 Z" /><path d="M3.5 7 L12 10 L20.5 7" /><path d="M12 10 V20" /><GoldNode cx={12} cy={10} /></Icon>;
const IconBlog = (p: any) => <Icon {...p}><path d="M5 4 H17 L19.5 6.5 V20 H5 Z" /><path d="M8 9 H16 M8 12 H16 M8 15 H13" /><GoldNode cx={17.5} cy={6.5} /></Icon>;
const IconVideo = (p: any) => <Icon {...p}><rect x="3" y="5.5" width="18" height="13" rx="1.5" /><path d="M10.5 9.5 L14.5 12 L10.5 14.5 Z" fill="currentColor" stroke="none" /><GoldNode cx={20} cy={8} r={1.2} /></Icon>;
...
const IconPlay = (p: any) => <Icon {...p}><circle cx="12" cy="12" r="9" /><path d="M10 8.5 L16 12 L10 15.5 Z" fill="currentColor" stroke="none" /></Icon>;
      ...
      {expanded && (
        <div style={{ padding: '0 18px 16px', borderTop: '1px solid var(--hair)' }}>
          ...
          <div className="row between center" style={{ marginTop: 14 }}>
            ...
            <button className="btn ghost sm" style={{ gap: 6 }}>
              <IconPlay size={12} /> Play recording
            </button>
          </div>
        </div>
      )}
        ...
        <div style={{ padding: '0 14px 12px', borderTop: '1px solid var(--hair)' }}>
          ...
          <div className="row between center" style={{ marginTop: 10 }}>
            ...
            <button style={{
              ...
              padding: '5px 10px', fontSize: 10, fontFamily: 'var(--mono)', letterSpacing: '0.08em',
              color: 'var(--ink)', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 4,
            }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        <div style={{ flex: 1, overflow: 'hidden', display: 'flex', gap: 0 }}>
          ...
          <div style={{ width: 240, borderLeft: '1px solid var(--hair)', padding: 20, overflow: 'auto', flexShrink: 0 }}>
            ...
            <div>
              <div style={{ fontSize: 11, color: 'var(--mute)', fontFamily: 'var(--mono)', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 8 }}>Recordings</div>
              <div style={{ fontSize: 12, color: 'var(--mute)', lineHeight: 1.5 }}>
                6 voice recordings available · AI-transcribed and summarised · Ask Dr. AI to query any session.
              </div>
